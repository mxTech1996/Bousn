...
export const dataSite = {
  ...
  products: [
    ...
    },
    {
      ...
      category: null,
      description:
        "Automate payroll calculations, tax withholdings, and direct deposits with our reliable payroll processing service. Stay compliant and ensure your employees are paid accurately and on time.",
      price: "10",
      stock: 100,
      content: "Payroll Processing Service, for small to medium businesses.",
      product_type: "NORMAL",
    ...
    },
    {
      ...
      category: null,
      description:
        "Receive personalized financial guidance to help your business achieve its long-term goals. Our expert consultants will help you create a roadmap for financial success.",
      price: "8",
      stock: 100,
      content: "Financial Planning Consultation, for business owners.",
      product_type: "NORMAL",
    ...
    },
    {
      ...
      category: null,
      description:
        "Track and manage business expenses effortlessly with our user-friendly software. Simplify expense reports, streamline approvals, and gain real-time visibility into spending.",
      price: "6",
      stock: 100,
      content: "Expense Management Software, for companies of all sizes.",
      product_type: "NORMAL",
    ...
    {
      id: 741,
      name: "Startup Business Accounting Kit",
      category: null,
      description:
        "Get your new business off to a strong start with our all-in-one accounting kit. Includes templates, guides, and tools for new entrepreneurs.",
      price: "10",
      stock: 100,
      content: "Startup Business Accounting Kit, essential for new businesses.",
      product_type: "NORMAL",
    ...
    },
    {
      ...
      category: null,
      description:
        "Don't face a tax audit alone. Our professionals will guide you through the process, providing expert advice and representation to minimize stress and potential issues.",
      price: "10",
      stock: 100,
      content: "Tax Audit Support, for individuals and businesses.",
      product_type: "NORMAL",
    ...
    },
    {
      ...
      category: null,
      description:
        "Our comprehensive bookkeeping service helps you maintain accurate financial records, reconcile accounts, and generate essential reports. Focus on your business while we handle the details.",
      price: "6",
      stock: 100,
      content: "Bookkeeping Service, for small businesses.",
      product_type: "NORMAL",
    ...
    },
    {
      ...
      category: null,
      description:
        "Get started with QuickBooks the right way. We offer professional setup, customization, and training to help you effectively manage your business finances from day one.",
      price: "4",
      stock: 100,
      content: "QuickBooks Setup and Training, for new and existing users.",
      product_type: "NORMAL",
    ...
    },
    {
      ...
      category: null,
      description:
        "Gain a deeper understanding of your company's financial health. Our analysis provides insights into profitability, liquidity, and solvency, helping you make smarter business decisions.",
      price: "8",
      stock: 100,
      content: "Financial Statement Analysis, for a detailed financial review.",
      product_type: "NORMAL",
